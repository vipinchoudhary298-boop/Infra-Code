...
networks = {
  vnet1 = {
    ...
    subnets = {
      s1 = {
        name             = "prod-frontend-subnet01"
        address_prefixes = ["10.0.1.0/24"]
      }
      s2 = {
        name             = "prod-backend-subnet01"
...
public_ips = {
  pip1 = {
    ...
    sku                 = "Standard"
    domain_name_label   = "prodpublicip01"
    idle_timeout        = 10
    zones               = ["1", "2", "3"]
...
vms = {
  vm1 = {
    ...
    subnet_name = "prod-frontend-subnet01"
    ip_configurations = {
      config1 = {
        name                          = "internal"
